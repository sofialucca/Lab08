...
public class ExtFlightDelaysDAO {
	...
	public List<Rotta> voliDistanzaMedia(Map<Integer,Airport> idMap, int x){
		String sql = "SELECT ORIGIN_AIRPORT_ID,DESTINATION_AIRPORT_ID, AVG(DISTANCE) media "
				+ "FROM flights "
		...
		try {
			...
			while (rs.next()) {
				...
				if(a1!=null && a2!= null) {
					result.add(new Rotta(a1,a2,rs.getInt("media")));
				}	
			}
